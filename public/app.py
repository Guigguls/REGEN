...
# Gemini client
client = genai.Client(api_key="REPLACE_WITH_GEMINI_API_KEY")  # e.g. "AIzaSyDYTzylNGK1FJHawTqa7cokN56q52jq9C4"

# Supabase config — REST API approach (no supabase package needed)
SUPABASE_URL = "REPLACE_WITH_SUPABASE_URL"  # e.g. https://xyzcompany.supabase.co

# 🔑 Credentials split setup to bypass Row-Level Security blocks
SUPABASE_PUBLIC_ANON_KEY = "REPLACE_WITH_SUPABASE_PUBLIC_ANON_KEY"  # e.g. ey
SUPABASE_SERVICE_KEY = "REPLACE_WITH_SUPABASE_SERVICE_KEY"  # e.g. eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...
